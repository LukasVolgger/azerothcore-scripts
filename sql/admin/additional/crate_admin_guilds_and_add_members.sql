...
INSERT INTO `guild` (`guildid`, `name`, `leaderguid`, `EmblemStyle`, `EmblemColor`, `BorderStyle`, `BorderColor`, `BackgroundColor`, `info`, `motd`, `createdate`, `BankMoney`) VALUES (1, 'Administrators', 1, 20, 16, 0, 16, 35, '', 'No message set.', 1691263014, 2140000000);
INSERT INTO `guild` (`guildid`, `name`, `leaderguid`, `EmblemStyle`, `EmblemColor`, `BorderStyle`, `BorderColor`, `BackgroundColor`, `info`, `motd`, `createdate`, `BankMoney`) VALUES (2, 'Alliance Administrators', 2, 20, 10, 0, 10, 32, '', 'No message set.', 1691263014, 2140000000);
INSERT INTO `guild` (`guildid`, `name`, `leaderguid`, `EmblemStyle`, `EmblemColor`, `BorderStyle`, `BorderColor`, `BackgroundColor`, `info`, `motd`, `createdate`, `BankMoney`) VALUES (3, 'Horde Administrators', 12, 20, 1, 0, 0, 44, '', 'No message set.', 1691263014, 2140000000);

-- guild_bank_eventlog
DELETE FROM `guild_bank_eventlog` WHERE `guildid`=1 AND `LogGuid`=0 AND `TabId`=100;
INSERT INTO `guild_bank_eventlog` (`guildid`, `LogGuid`, `TabId`, `EventType`, `PlayerGuid`, `ItemOrMoney`, `ItemStackCount`, `DestTabId`, `TimeStamp`) VALUES (1, 0, 100, 4, 1, 2140000000, 0, 0, 1691263014);
-- Alliance
DELETE FROM `guild_bank_eventlog` WHERE `guildid`=2 AND `LogGuid`=0 AND `TabId`=100;
INSERT INTO `guild_bank_eventlog` (`guildid`, `LogGuid`, `TabId`, `EventType`, `PlayerGuid`, `ItemOrMoney`, `ItemStackCount`, `DestTabId`, `TimeStamp`) VALUES (2, 0, 100, 4, 2, 2140000000, 0, 0, 1691263014);
-- Horde
DELETE FROM `guild_bank_eventlog` WHERE `guildid`=3 AND `LogGuid`=0 AND `TabId`=100;
INSERT INTO `guild_bank_eventlog` (`guildid`, `LogGuid`, `TabId`, `EventType`, `PlayerGuid`, `ItemOrMoney`, `ItemStackCount`, `DestTabId`, `TimeStamp`) VALUES (3, 0, 100, 4, 12, 2140000000, 0, 0, 1691263014);
...
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (1, 0, 2, 1, 0, 0, 1691263014);
-- Alliance
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=0;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 0, 2, 2, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=1;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 1, 2, 3, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=2;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 2, 2, 4, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=3;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 3, 2, 5, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=4;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 4, 2, 6, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=5;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 5, 2, 7, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=6;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 6, 2, 8, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=7;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 7, 2, 9, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=8;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 8, 2, 10, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=2 AND `LogGuid`=9;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (2, 9, 2, 11, 0, 0, 1691263014);
-- Horde
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=0;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 0, 2, 12, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=1;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 1, 2, 13, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=2;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 2, 2, 14, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=3;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 3, 2, 15, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=4;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 4, 2, 16, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=5;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 5, 2, 17, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=6;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 6, 2, 18, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=7;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 7, 2, 19, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=8;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 8, 2, 20, 0, 0, 1691263014);
DELETE FROM `guild_eventlog` WHERE `guildid`=3 AND `LogGuid`=9;
INSERT INTO `guild_eventlog` (`guildid`, `LogGuid`, `EventType`, `PlayerGuid1`, `PlayerGuid2`, `NewRank`, `TimeStamp`) VALUES (3, 9, 2, 21, 0, 0, 1691263014);
...
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (1, 0, 'Gildenmeister', 1962495, 4294967295);
DELETE FROM `guild_rank` WHERE `guildid`=1 AND `rid`=1;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (1, 1, 'Offizier', 1962495, 0);
DELETE FROM `guild_rank` WHERE `guildid`=1 AND `rid`=2;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (1, 2, 'Veteran', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=1 AND `rid`=3;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (1, 3, 'Mitglied', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=1 AND `rid`=4;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (1, 4, 'Anfänger', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=2 AND `rid`=0;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (2, 0, 'Gildenmeister', 1962495, 4294967295);
DELETE FROM `guild_rank` WHERE `guildid`=2 AND `rid`=1;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (2, 1, 'Offizier', 1962495, 0);
DELETE FROM `guild_rank` WHERE `guildid`=2 AND `rid`=2;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (2, 2, 'Veteran', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=2 AND `rid`=3;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (2, 3, 'Mitglied', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=2 AND `rid`=4;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (2, 4, 'Anfänger', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=3 AND `rid`=0;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (3, 0, 'Gildenmeister', 1962495, 4294967295);
DELETE FROM `guild_rank` WHERE `guildid`=3 AND `rid`=1;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (3, 1, 'Offizier', 1962495, 0);
DELETE FROM `guild_rank` WHERE `guildid`=3 AND `rid`=2;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (3, 2, 'Veteran', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=3 AND `rid`=3;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (3, 3, 'Mitglied', 67, 0);
DELETE FROM `guild_rank` WHERE `guildid`=3 AND `rid`=4;
INSERT INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES (3, 4, 'Anfänger', 67, 0);
